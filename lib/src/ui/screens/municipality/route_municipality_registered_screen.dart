...
class RouteMunicipalityRegisteredScreen extends StatefulWidget {
  final bool isArchive;

  const RouteMunicipalityRegisteredScreen({Key key, this.isArchive})
      : super(key: key);

  @override
  _RouteMunicipalityRegisteredScreenState createState() =>
      _RouteMunicipalityRegisteredScreenState();
}

class _RouteMunicipalityRegisteredScreenState
    extends State<RouteMunicipalityRegisteredScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).translate("registeredMunicipalities"), style: TextStyle(color: Theme.of(context).accentColor),),
        actions: <Widget>[
          IconButton(
            icon: Icon(
              Icons.search,
            ...
            onPressed: () async {
              final result = await navigateTo(
                context,
                SearchMunicipalityScreen(registeredOnly: true,),
                isWaiting: true,
              );
